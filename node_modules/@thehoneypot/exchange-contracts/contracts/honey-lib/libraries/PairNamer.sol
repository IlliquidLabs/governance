...
// produces names for pairs of tokens using Honey's naming scheme
library PairNamer {
    string private constant TOKEN_SYMBOL_PREFIX = 'HONEY:';
    ...
    // produces a pair symbol in the format of `PNG:${symbol0}:${symbol1}${suffix}`
    function pairSymbol(
        address token0,
        address token1,
        string memory suffix
